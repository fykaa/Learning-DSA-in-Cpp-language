...
//         ptr->top = ptr->top -1;
//         // ptr->top--;               //ARRAY mein hame element ko FREE karne ki zarurat nahi hoti hai!, kyuki aap use refer hi nahi karrahe ho abb toh vo automatically removed hai. so now that ptr->top is not referring last element , its no more the part of the array!!!
//         return val;
//     }
// }
