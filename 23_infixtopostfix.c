...
char *infixTOpostfix(char *infix)
{
    ...
    // struct Stack * store;  //ye kaam nahi karraha tha kyuki hamne stack ka instance banaya hi nahi even hamne array ko malloc mein space di,
    //we also have to give space to stack in space using malloc, else function wont run!!!!!!!
